...
<nav  class="navvvvvvbar navvvvvvbar-default navvvvvvbar-top">
      <div  class="  navvvvvvbar-brand navvvvvvbar-center"><b><mark><img src=""/>Quick-Book<img src="https://img.icons8.com/?size=1x&id=fyrNpf6lkG1y&format=png"/></mark></b>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <ul class="nav navbar-nav navbar-left">
          ...
          <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#">User Bookings<span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href='trainbookings.php'><center>Train Bookings<center></a></li>
            <li><a href='busbookings.php'><center>Bus Bookings<center></a></li>
          </ul>
          </li>
          </ul>
        </ul>
